        ...
        <div className="relative overflow-clip min-h-screen text-white bg-[linear-gradient(to_bottom,#000,#071E18_35%,#208A65_67%,#35FB8E_85%)]">
            <div
                className="absolute bg-black w-[2400px] h-[1000px] rounded-[50%] left-1/2 -translate-x-1/2
                           ...
                           border-[1px] border-[#8CD6DE]/[0.30]" // HATA 1 DÜZELTİLDİ
            />
                ...
                <div className="flex flex-col items-center justify-center text-center z-10">
                    ...
                    >
                        ...
                        <div className="flex gap-4 justify-center">
                            ...
                            <motion.button
                                whileHover={{ scale: 1.05 }}
                                className="px-6 py-3 border border-white/20 rounded-full font-medium hover:bg-white/10 transition-colors" // HATA 2 DÜZELTİLDİ
                            >
                                Çalışmalarım
                            </motion.button>
                        </div>
