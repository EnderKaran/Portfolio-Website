...
export default function NotFound() {
  ...
  const pupilRef1 = useRef<HTMLDivElement>(null);
  const pupilRef2 = useRef<HTMLDivElement>(null);
    ...
    <div className="relative w-full h-screen overflow-hidden text-white space-bg font-poppins">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 text-center">
        ...
        <div className="relative w-[260px] h-[260px] mt-[-40px] astronaut-float" ref={astronautRef}>
          ...
          />
          <div ref={visorRef} className="absolute w-[60px] h-[45px] rounded-[50%] overflow-hidden opacity-90 z-[5] top-[40px] left-[100px]">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="mt-8">
          ...
          <div className="flex flex-col gap-4 sm:flex-row justify-center">
            <Link href="/" className="flex items-center justify-center gap-2 px-8 py-3 font-bold text-black transition-all duration-300 rounded-lg shadow-lg bg-emerald-400 hover:bg-white hover:scale-105">
              <FaHome /> Ana Sayfaya Dön
            </Link>
            <a href="mailto:ender.karan14@gmail.com" className="flex items-center justify-center gap-2 px-8 py-3 font-bold text-white transition-all duration-300 border-2 rounded-lg border-emerald-400/30 hover:bg-emerald-400/10 hover:border-emerald-400">
