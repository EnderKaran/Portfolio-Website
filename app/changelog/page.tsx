...
// İhtiyacımız olan ikonları ekledik (FaDatabase eklendi)
import { 
  FaPlus, FaWrench, FaRocket, FaCube, FaPalette, 
  FaMobileAlt, FaMousePointer, FaColumns, FaBug, 
  FaBullseye, FaMagic, FaExclamationTriangle, FaArrowUp, FaDatabase 
} from 'react-icons/fa'; 
    ...
    const changelogData = [
        {
            ...
            changes: [
                { 
                    ...
                    description: t('changelog_v2_1_0_desc1'), 
                    icon: <FaPlus /> 
                },
                { 
                    type: t('changelog_type_archchange'), 
                    description: t('changelog_v2_1_0_desc2'), 
                    icon: <FaDatabase /> 
                },
                { 
                    type: t('changelog_type_improvement'), 
                    description: t('changelog_v2_1_0_desc3'), 
                    icon: <FaMagic /> 
                },
                { 
                    type: t('changelog_type_structure'), 
                    description: t('changelog_v2_1_0_desc4'), 
                    icon: <VscFileCode /> 
                },
            ]
        },
        ...
        },
        {
            ...
            changes: [
                ...
                { 
                    type: t('changelog_type_improvement'), 
                    description: t('changelog_v1_9_0_desc2'),
                    icon: <FaWrench /> 
                },
            ]
        },
        {
            ...
            date: "02 Aralık 2025",
            changes: [
                { type: t('changelog_type_bugfix'), description: t('changelog_v1_8_0_desc1'), icon: <FaPalette /> },
                { type: t('changelog_type_improvement'), description: t('changelog_v1_8_0_desc2'), icon: <FaWrench /> },
                { type: t('changelog_type_responsive'), description: t('changelog_v1_8_0_desc3'), icon: <FaMobileAlt /> },
                { type: t('changelog_type_archchange'), description: t('changelog_v1_8_0_desc4'), icon: <VscFileCode /> },
            ]
        },
        {
            version: "v1.0.0",
